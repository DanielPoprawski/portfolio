                  ...
                  <div className="flex flex-col items-center min-h-screen bg-gray-50 bg-opacity-75 py-12 px-4 sm:px-6 lg:px-8">
                        <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50">
                              <form
                                    ...
                                    className="w-full max-w-xl space-y-6 bg-slate-50 px-6 py-4 rounded-lg shadow-lg"
                              >
                                    <div>
                                          <h2 className="text-3xl font-bold text-gray-900 mb-4">Contact:</h2>
                                          <p className="text-gray-600 text-center max-w-2xl mb-8">
                                                If you would like to contact me, please leave a message here with your
                                                name, email (or phone number) and what services I may provide for you
